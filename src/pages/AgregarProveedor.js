...
export default function AgregarProveedor() {
  return (
    ...
    <div className="mb-3">
        <label htmlFor="cuit_proveedor" className="form-label">CUIT</label>
        <input type="number" step="any" className="form-control" id="cuit_proveedor" name="cuit_proveedor" value={cuit_proveedor} onChange={(e)=> onInputChange(e)} />
    </div>
    <div className="mb-3">
